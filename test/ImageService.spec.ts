...
// test.skip("ImageService.uploadPhoto should upload and save a user Photo", async (assert) => {
...
// test.skip("ImageService.uploadProductImages should upload one or many product images", async (assert) => {
//   const { text } = await api
